PaulSantoroWebsite.controller("stone-controller", 
	["$scope", 
	function StoneController($scope) {
		...
		function initialize() {
			...
			let projectImages = [
				"../Resources/stone_img1.png",
				"../Resources/stone_img2.png",
				"../Resources/stone_img3.png",
				"../Resources/stone_img4.png",
				"../Resources/stone_img5.png"
			];
